...
import software_image from "../../../photos/software.png";
import { Link } from "react-router-dom";
const software = () => {
  return (
    <div className="group hover:bg-blue-hover bg-blue-without-hover w-[65vw] md:w-1/4 my-12 relative text-left z-50 transition duration-300">
      {/* Without hover */}
      <div className="group-hover:hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center   font-bold text-white z-50 ">
          <div className="bg-VUT-blue px-2 py-1 inline-block ">SOFTWARE</div>
          <div className="bg-VUT-red px-4 py-1 inline">ENGINEERING</div>
        </div>
        <div className="bg-black/60 absolute bottom-0 w-full h-[25%]"></div>
      </div>
      {/* With hover */}
      <div className="group-hover:block hidden absolute left-0 top-0  w-full h-full    z-50">
        <h1 className="text-lg font-bold text-VUT-blue text-center mt-6 w-full">
        ...
        <div className="ml-5 absolute top-[40%] w-full">
          ...
          <ul className=" text-xs  font-semibold mt-6 list-disc   ">
            <li className="">
              Programming languages C, <br /> Python, Oracle ...
            </li>
      ...
      <img className="opacity-[.18]" src={software_image} alt="software" />
    </div>
  );
};
